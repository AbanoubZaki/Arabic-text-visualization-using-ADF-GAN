...
class TextDataset(data.Dataset):
    ...
    def load_captions(self, data_dir, filenames):
        all_captions = []
        text_dir = '%s/arabic_text' % (data_dir)
    ...
    def load_text_data(self, data_dir, split):
        filepath = os.path.join(data_dir, 'arabic_captions.pickle')
...
class TextBertDataset(TextDataset):
    """
    Text dataset on araBert
    https://huggingface.co/aubmindlab
    """
    def __init__(self, *args, **kwargs):
        self.tokenizer = AutoTokenizer.from_pretrained(cfg.GAN.BERT_NAME)
        self.arabert_prep = ArabertPreprocessor(cfg.GAN.BERT_NAME)
        ...
        for i in range(len(filenames)):
            ...
            with open(cap_path, "r") as f:
                ...
                for cap in captions:
                    ...
                    #preprocess cap
                    # print(f'cap = {cap}')
                    cap = self.arabert_prep.preprocess(cap)
